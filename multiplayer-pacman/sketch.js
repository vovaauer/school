...
function preload() {
  ...
  images = {
    ...
    speedy: {
      up: loadImage("assets/speedy_up.png"),
      left: loadImage("assets/speedy_left.png"),
      down: loadImage("assets/speedy_down.png"),
      right: loadImage("assets/speedy_right.png"),
    },
    bashful: {
      up: loadImage("assets/bashful_up.png"),
      left: loadImage("assets/bashful_left.png"),
      down: loadImage("assets/bashful_down.png"),
      right: loadImage("assets/bashful_right.png"),
    },
    pokey: {
      up: loadImage("assets/pokey_up.png"),
      left: loadImage("assets/pokey_left.png"),
      down: loadImage("assets/pokey_down.png"),
